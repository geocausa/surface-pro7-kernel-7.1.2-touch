...
IMAGE_DEB="linux-image-7.1.2-surface-aa3+_7.1.2-surface-aa3_amd64.deb"
HEADERS_DEB="linux-headers-7.1.2-surface-aa3+_7.1.2-surface-aa3_amd64.deb"
LIBC_DEB="linux-libc-dev_7.1.2-surface-aa3_amd64.deb"
RELEASE_URL="https://github.com/geocausa/surface-pro7-kernel-7.1.2-touch/releases/download/v7.1.2-surface-aa3"
...
echo
echo "Installed 7.1.2-surface-aa3+ and iptsd."
